...
export default function Home({ onNavigate }) {
  const stats = [
    { label: 'Years of Excellence', value: 'XX+', desc: '[Placeholder]' },
    { label: 'Students Enrolled', value: 'XX+', desc: '[Placeholder]' },
    { label: 'Qualified Staff', value: 'XX+', desc: '[Placeholder]' },
    { label: 'Academic Programmes', value: 'XX', desc: '[Placeholder]' },
  ];
  ...
  const programmes = [
    { title: 'Junior Secondary Education', subtitle: 'JSS 1 – JSS 3', icon: '📚' },
    { title: 'Senior Secondary Education', subtitle: 'SSS 1 – SSS 3', icon: '🎓' },
    { title: 'Science & Technology', subtitle: 'Department [Placeholder]', icon: '🔬' },
    { title: 'Arts & Humanities', subtitle: 'Department [Placeholder]', icon: '✏️' },
    { title: 'Commercial Studies', subtitle: 'Department [Placeholder]', icon: '📊' },
    { title: '[Additional Programme]', subtitle: 'School to confirm', icon: '⭐' }
  ];

  const studentLifeCards = [
    { title: 'Sports', img: 'https://images.unsplash.com/photo-1526232761682-d26e03ac148e?auto=format&fit=crop&w=500&q=80' },
    { title: 'Clubs & Societies', img: 'https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=500&q=80' },
    { title: 'Cultural Activities', img: 'https://images.unsplash.com/photo-1577896851231-70ef18881754?auto=format&fit=crop&w=500&q=80' },
    { title: 'Leadership', img: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=500&q=80' },
    { title: 'School Events', img: 'https://images.unsplash.com/photo-1529390079861-591de354faf5?auto=format&fit=crop&w=500&q=80' }
  ];

  const admissionCards = [
    { title: 'Entry Levels', desc: '[JSS 1 & SSS 1]', icon: '🏫' },
    { title: 'Who Can Apply', desc: '[See requirements]', icon: '👤' },
    { title: 'Admission Period', desc: '[Dates placeholder]', icon: '📅' },
    { title: 'Contact Admissions', desc: '[Office phone/email]', icon: '📞' }
  ];
  ...
  const galleryImages = [
    { title: 'Classroom Study', span: 'col-span-12 sm:col-span-6 lg:col-span-5 h-[320px]', img: 'https://images.unsplash.com/photo-1580582932707-520aed937b7b?auto=format&fit=crop&w=800&q=80' },
    { title: 'Student Writing', span: 'col-span-6 sm:col-span-3 lg:col-span-3 h-[155px]', img: 'https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=500&q=80' },
    { title: 'Reading Time', span: 'col-span-6 sm:col-span-3 lg:col-span-4 h-[155px]', img: 'https://images.unsplash.com/photo-1577896851231-70ef18881754?auto=format&fit=crop&w=500&q=80' },
    { title: 'Science Lab Focus', span: 'col-span-6 sm:col-span-3 lg:col-span-3 h-[150px]', img: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fit=crop&w=500&q=80' },
    { title: 'Computer Lab Work', span: 'col-span-6 sm:col-span-3 lg:col-span-4 h-[150px]', img: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=500&q=80' },
    { title: 'Class raising hands', span: 'col-span-6 sm:col-span-3 lg:col-span-3 h-[140px]', img: 'https://images.unsplash.com/photo-1529390079861-591de354faf5?auto=format&fit=crop&w=500&q=80' },
    { title: 'Students at desks', span: 'col-span-6 sm:col-span-3 lg:col-span-3 h-[140px]', img: 'https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?auto=format&fit=crop&w=500&q=80' },
  ];

  const testimonials = [
    {
      text: '"[Parent testimonial placeholder] — The school has exceeded our expectations in both academic quality and the care they show for each student’s development."',
      name: 'Parent Name [Placeholder]',
      role: 'Parent of JSS 2 Student'
    },
    {
      text: '"[Student testimonial placeholder] — Being a student here has shaped my character, sharpened my thinking, and prepared me for the future I am working toward."',
      name: 'Student Name [Placeholder]',
      role: 'SSS 3 Student'
    },
    {
      text: '"[Parent testimonial placeholder] — We are proud to have our child in a school that takes both academics and discipline as seriously as New State High School does."',
      name: 'Parent Name [Placeholder]',
      ...
      <section className="py-20 px-6 bg-white border-t border-gray-100">
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="mt-8 text-center text-xs text-gray-400 italic">
            ✏️ These programme labels are editable placeholders. The school should update them to reflect its actual academic structure.
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                { title: 'Science Laboratory', desc: '[Placeholder]', img: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fit=crop&w=500&q=80' },
                { title: 'Library', desc: '[Placeholder]', img: 'https://images.unsplash.com/photo-1521587760476-6c12a4b040da?auto=format&fit=crop&w=500&q=80' },
                { title: 'ICT / Computer Room', desc: '[Placeholder]', img: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=500&q=80' },
                { title: 'Sports & Recreation', desc: '[Placeholder]', img: 'https://images.unsplash.com/photo-1526232761682-d26e03ac148e?auto=format&fit=crop&w=500&q=80' },
              ].map((fac, idx) => (
        ...
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {studentLifeCards.map((item, idx) => (
              <div key={idx} className="relative rounded-2xl overflow-hidden shadow-sm h-56 group">
                <img 
                  src={item.img} 
                  alt={item.title} 
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-4 flex flex-col justify-end text-white">
                  <h3 className="text-xs sm:text-sm font-bold leading-tight">{item.title}</h3>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-[1280px] mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <div className="text-xs text-gray-400 italic">
              ✏️ These are placeholder testimonials. Replace with real quotes from the school community.
            </div>
          </div>
        ...
        <div className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15">
              <div className="text-emerald-300 text-sm mb-2">📍 ADDRESS</div>
              <div className="font-bold text-xs sm:text-sm">Mushin, Lagos State, Nigeria</div>
            </div>

            <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15">
              <div className="text-emerald-300 text-sm mb-2">📞 PHONE</div>
              <div className="font-bold text-xs sm:text-sm">[Phone Placeholder]</div>
            </div>

            <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15">
              <div className="text-emerald-300 text-sm mb-2">✉️ EMAIL</div>
              <div className="font-bold text-xs sm:text-sm">[Email Placeholder]</div>
            </div>

            <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15">
              <div className="text-emerald-300 text-sm mb-2">🕒 OFFICE HOURS</div>
              <div className="font-bold text-xs sm:text-sm">Mon – Fri, [Hours Placeholder]</div>
            </div>
          </div>
        </div>
      </section>
